...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, ISM43362_RST_Pin|ISM43362_SPI3_CSN_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : PMOD_D1_Pin PMOD_D2_Pin */
  GPIO_InitStruct.Pin = PMOD_D1_Pin|PMOD_D2_Pin;
  ...
  /*Configure GPIO pins : ISM43362_WAKEUP_Pin LED2_Pin */
  ...
  /*Configure GPIO pin : LED_WIFI_ACTIVITY_Pin */
